...
`Geaux.Specification` belongs to the **Domain & Application Layer** in Clean Architecture.

It **may be referenced by**:

* Domain projects (`Geaux.Core`)
* UseCase projects (`Geaux.UseCases`)
* Infrastructure EF Core projects
* Test projects
